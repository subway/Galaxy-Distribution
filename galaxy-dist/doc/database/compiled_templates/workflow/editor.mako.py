...
_magic_number = 6
_modified_time = 1386010554.188148
...
def _mako_generate_namespaces(context):
    # SOURCE LINE 420
    ns = runtime.TemplateNamespace('__anon_0x169c95d0', context._clean_inheritance_tokens(), templateuri=u'/tagging_common.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x169c95d0')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x169c95d0')._populate(_import_ns, [u'render_individual_tagging_element'])
