...
_magic_number = 6
_modified_time = 1384451924.084715
...
def _mako_generate_namespaces(context):
    # SOURCE LINE 2
    ns = runtime.TemplateNamespace('__anon_0x258ac310', context._clean_inheritance_tokens(), templateuri=u'/message.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x258ac310')] = ns

    # SOURCE LINE 3
    ns = runtime.TemplateNamespace('__anon_0x258ac150', context._clean_inheritance_tokens(), templateuri=u'/base_panels.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x258ac150')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x258ac310')._populate(_import_ns, [u'render_msg'])
        _mako_get_namespace(context, '__anon_0x258ac150')._populate(_import_ns, [u'overlay'])
    ...
    # Name of the tool in lower case
        ...
        if trans.app.config.biostar_url:
            # SOURCE LINE 326
            __M_writer(u'            <span class="pull-right"><a href="')
            __M_writer(unicode(h.url_for( controller='biostar', action='biostar_tool_question_redirect', tool_id=tool.id )))
            __M_writer(u'" target="_blank" class="fa-icon-question-sign" title="Ask a question about this tool"></a></span>\n')
            pass
        # SOURCE LINE 328
