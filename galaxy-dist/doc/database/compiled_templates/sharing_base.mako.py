...
_magic_number = 6
_modified_time = 1384522057.067403
...
def _mako_generate_namespaces(context):
    # SOURCE LINE 18
    ns = runtime.TemplateNamespace('__anon_0x18e70210', context._clean_inheritance_tokens(), templateuri=u'/display_common.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x18e70210')] = ns

    # SOURCE LINE 19
    ns = runtime.TemplateNamespace('__anon_0x1922bb10', context._clean_inheritance_tokens(), templateuri=u'/message.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x1922bb10')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x18e70210')._populate(_import_ns, [u'*'])
        _mako_get_namespace(context, '__anon_0x1922bb10')._populate(_import_ns, [u'render_msg'])
