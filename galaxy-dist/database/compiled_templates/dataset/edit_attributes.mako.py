...
_magic_number = 6
_modified_time = 1384453412.520175
...
def _mako_generate_namespaces(context):
    # SOURCE LINE 175
    ns = runtime.TemplateNamespace('__anon_0x2665bd10', context._clean_inheritance_tokens(), templateuri=u'/dataset/security_common.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x2665bd10')] = ns

    # SOURCE LINE 2
    ns = runtime.TemplateNamespace('__anon_0x2b4710296610', context._clean_inheritance_tokens(), templateuri=u'/message.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x2b4710296610')] = ns

    # SOURCE LINE 3
    ns = runtime.TemplateNamespace('__anon_0x2b4710296410', context._clean_inheritance_tokens(), templateuri=u'/refresh_frames.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x2b4710296410')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x2665bd10')._populate(_import_ns, [u'render_permission_form'])
        _mako_get_namespace(context, '__anon_0x2b4710296610')._populate(_import_ns, [u'render_msg'])
        _mako_get_namespace(context, '__anon_0x2b4710296410')._populate(_import_ns, [u'handle_refresh_frames'])
